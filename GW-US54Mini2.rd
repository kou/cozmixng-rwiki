...
((<ライセンスを確認|http://rt2x00.serialmonkey.com/wiki/index.php?title=Firmware_license>))してrt73の((<ファームウェアをダウンロード|http://www.ralinktech.com.tw/data/RT71W_Firmware_V1.8.zip>))する。((-.zipの中にもライセンスが入っている。-))
